...
/**
 * Take in a path and return a list of captured fields for this route
 *
 * @param {String} path the url path
 * @returns {Object} the fields captured from the url
 */
 ...
 * @returns {Object} a promise which will resolve if the request is succesfully
 *     handled
 */
 ...
 *
 * @returns {Route} the route attached to this node
 */
